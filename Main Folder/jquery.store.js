(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "Item-"; // Prefix string to be prepended to the cart's name in the session storage
		...
		displayUserDetails: function() {
			if( this.$userDetails.length ) {
				if( this.storage.getItem( "shipping-name" ) == null ) {
					...
					var payment = this.storage.getItem( "billing-payment" );
					...
					var sPayment = this.storage.getItem( "shipping-payment" );
		...
		_saveFormData: function( form ) {
			...
			$visibleSet.each(function() {
				...
				if( $set.is( "#fieldset-billing" ) ) {
					...
					self.storage.setItem( "billing-payment", payment );
				} else {
					...
					self.storage.setItem( "shipping-payment", sPayment );
